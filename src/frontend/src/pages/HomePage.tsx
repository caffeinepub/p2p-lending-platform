        ...
        <div className="container relative py-24 lg:py-32">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed max-w-2xl">
              Connect directly with lenders and borrowers. Cut out the
              middlemen. Earn competitive returns or access capital backed by
              crypto and commodity collateral.
            </p>
      ...
      <section className="container py-20 lg:py-28">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Transparent, secure, and decentralized lending built on blockchain
            technology
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="border-2 hover:border-primary/50 transition-colors">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                All loans secured by collateral. Smart contracts ensure
                automatic execution and transparency.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-accent/50 transition-colors">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Lenders earn higher interest rates by cutting out traditional
          ...
          <Card className="border-2 hover:border-success/50 transition-colors">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Borrowers get instant access to capital without lengthy approval
          ...
          <Card className="border-2 hover:border-warning/50 transition-colors">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Support for top cryptocurrencies and precious metals as
                collateral. Your funds are protected.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-primary/50 transition-colors">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Built-in reputation system rewards reliable borrowers and
                lenders with better terms.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-accent/50 transition-colors">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Earn badges and increase your reputation to unlock better rates
                and higher limits.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="container py-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Join the decentralized lending revolution. Connect your Internet
              Identity and start lending or borrowing in minutes.
            </p>
            {identity ? (
